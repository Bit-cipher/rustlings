...
fn valid_component(value: i16) -> Option<u8> {
...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        match (valid_component(tuple.0), valid_component(tuple.1), valid_component(tuple.2)) {
            (Some(r), Some(g), Some(b)) => Ok(Color { red: r, green: g, blue: b }),
